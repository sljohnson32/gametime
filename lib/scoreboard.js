...
var textArray = ['Click screen and hit Enter to begin. Use left/right arrows to move paddle.', '','Hit Enter and try harder this time.', 'You destroyed the brick block! Hit Enter to start Level 2!', 'You lost. Hit Enter if you want to start a new game and try harder.', 'You WON the game! Congrats! Hit Enter to play again.'];
